              ...
              <div className="grid grid-cols-4 gap-4">
                {currentNodes.map((node, index) => (
                  <button
                    ...
                    className={`group relative p-6 rounded-xl text-left transition-all duration-200 hover:scale-[1.02] hover:shadow-lg ${
                      node.color || TILE_COLORS[index % TILE_COLORS.length]
                    } text-white`}
                  >
                    ...
                    <p className="text-sm text-white/80 leading-relaxed">{node.description}</p>
                    {node.isTerminal && (
